...
public:
    ...
    static void trace_increment(const int& quadrant, const bool& run_over_rise, // Increment p_a.x, p_a.y toward 'quadrant',
    ...
    static Point cartesianToArray(const int& width, const int& height,          // Translate center-origin 2D coordinates to array coordinates
                                  const Point& p);
    static Point arrayToCartesian(const int& width, const int& height,          // Translate array coordinates to center-origin 2D coordinates
                                  const Point& p_a);
};
